/* Guillermo tiene N dolares. Luis tiene la mitad de los que posee Guillermo
Juan tiene la mitad de los que poseee Luis y Guillermo juntos. Hacer un programa
...
float guillermo, luis,juan,total;
        ...
        System.out.println("\nEl dinero de Luis es de: US$ "+ luis);
        System.out.println("El dinero de Juan es de: US$"+ juan);
